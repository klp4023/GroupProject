...
public class Water extends Building implements Serializable{
	 ...
	 */
	public Water(int x1, int y1, int x2, int y2) {
		super(x1, y1, x2, y2, ControlPanel.water);
	}

	/**
	 * How to draw an academic building by using the image of an water.
	 * 
	 * 
	 * @param g
	...
	public void draw(Graphics g) {
		g.drawImage(SimU.water.getImage(), // the image
